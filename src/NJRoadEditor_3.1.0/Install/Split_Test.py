...
class SplitCanvas(Tk.Canvas):
    def __init__(self, parent=None, SegmentNumber = None, scratchPath = None, FpSegment = None, Domains = None, Elev_to_Split = None, Address_to_Split = None, USER = None):
...
##            os.remove(filehandlerpath)
        ...
        self.logger.info('SplitCanvas Class Called...')
    ...
    ##                    sys.stdout.write('OK')
            ...
            def tool_info():
                ...
                help_split_path = os.path.join(os.path.dirname(__file__),'Split.html')
...
##    ## Canvas
##    cnv = Canvas(root, relief=SUNKEN)
##    ##cnv.configure(width=00, height=800)
##    ##cnv.configure(scrollregion=(0,0,600, 2000))
##    cnv.grid(row=0, column=0, sticky='nswe')
    ...
    if Address_to_Split:
        splitcanv = SplitCanvas(root, SegmentNumber, scratchPath, FpSegment, Domains, Elev_to_Split, Address_to_Split, USER)
    else:
        Address_to_Split = None
        splitcanv = SplitCanvas(root, SegmentNumber, scratchPath, FpSegment, Domains, Elev_to_Split, Address_to_Split, USER)
...
##    sidebutt = Tk.Button(root,text='butt',relief='flat').grid(row=0,column=0)
...
##    def call(event):
##        print 'entered', event.x, event.y
##    splitcanv.bind("<Enter>", call)
##    splitcanv.     entry_addrlfr.bind("<Enter>", call)

    #t1 = ToolTip(splitcanv, follow_mouse=1, text="I'm a tooltip with follow_mouse set to 1, so I won't be placed outside my parent")
